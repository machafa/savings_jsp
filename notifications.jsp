...
<div id="main">  
  <div style="font-family: indie flower;background-color: rgb(42,0,84); color: aliceblue; font-size: 30px; text-align: center;">Lets learn how to keep track of our spendings and save money</div>
